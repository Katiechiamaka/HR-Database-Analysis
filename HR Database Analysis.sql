-- HR DATABASE PROJECT ANALYSIS
-- Add tables to the HR DATABASE
...
-- Adding a column called department
...
-- Checking the newly Created Table and it's columns
...
-- Checking the information on the Department table
SELECT * 
FROM department;

-- Inserting Information into the Location Table
INSERT INTO location (location_id, location_point, employee_id)
VALUES
...
## checking the information in the location table
SELECT *
FROM location;
